...
%}
%token AS AT BREAK COLON COMMA DEF DIV DIV_DIV DOLLER_LPAR DOLLER_QUESTION DOT
%token ELIF ELSE END EOF EQUAL EQUAL_EQUAL ERR_RIGHT_ARROW ERR_RIGHT_ARROW_OUT
%token ERR_RIGHT_RIGHT_ARROW EVERY FALSE GREATER GREATER_EQUAL IF LBRACE
%token LBRACKET LEFT_ARROW LEFT_RIGHT_ARROW LESS LESS_EQUAL LPAR MINUS NEWLINE
%token NEXT NOT_EQUAL OUT_RIGHT_ARROW OUT_RIGHT_ARROW_ERR OUT_RIGHT_RIGHT_ARROW
%token PLUS RBRACE RBRACKET RETURN RIGHT_ARROW RIGHT_ARROW2 RIGHT_RIGHT_ARROW
